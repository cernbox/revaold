...
%changelog
* Tue Nov 09 2021 Ishank Arora <ishank.arora@cern.ch> 0.0.55
...
* Wed Oct 27 2021 Ishank Arora <ishank.arora@cern.ch> 0.0.53
- Use modified sql share schema
* Tue Oct 26 2021 Ishank Arora <ishank.arora@cern.ch> 0.0.52
- Retrieve shares where current user is initiator as well
* Wed Jun 17 2021 Diogo Castro <diogo.castro@cern.ch> 0.0.51
- Remove file shares from shared with me
* Wed Mar 10 2021 Hugo Gonzalez Labrador <hugo.gonzalez.labrador@cern.ch> 0.0.50
- Remove migration logic for EOSUSER retirement
* Thu Oct 15 2020 Hugo Gonzalez Labrador <hugo.gonzalez.labrador@cern.ch> 0.0.49
- Bump logger version
* Wed Aug 05 2020 Diogo Castro <diogo.castro@cern.ch> 0.0.48
- .md and .zmd as markdown files
* Wed Jun 17 2020 Diogo Castro <diogo.castro@cern.ch> 0.0.47
- Retrieve non orphan shares
