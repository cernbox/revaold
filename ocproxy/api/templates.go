...
<header>
	<div id="header" class="share-folder" data-protected="false" data-owner-display-name="admin" data-owner="admin" data-name="Documents">
		<a href="/" title="" id="owncloud">
		<h1 class="logo-icon">ownCloud</h1></a>
